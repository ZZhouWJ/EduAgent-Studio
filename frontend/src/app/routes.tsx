  ...
  [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "teacher/feedback", lazy: async () => ({ Component: (await import("./pages/TeacherFeedback")).TeacherFeedback }) },
        ...
        { path: "admin/roles", lazy: async () => ({ Component: (await import("./pages/AdminRoles")).AdminRoles }) },
